...
path_output_dir = path_vmoutput + '2024-12-03_bysmiles/'
...
# store 
df_e_v[list_cols].round(5).to_csv(path_output + 'gp_CV-errors_bysmiles.csv', index=False)
#df_e_v[list_cols].round(5).to_csv(path_output + 'gp_CV-errors.csv', index=False)
