...
# LASSO: Single species data, updated ADORE, 2023-11-24
...
df_preds = df_preds.sort_values(['challenge', 'chem_fp', 'groupsplit'])
...
# store 
df_e_v[list_cols].round(5).to_csv(path_output + 'lasso_CV-errors_singlespecies.csv', index=False)

# %%

# TODO update for single species
