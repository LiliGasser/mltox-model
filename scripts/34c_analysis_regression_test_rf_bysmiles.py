...
for i, param in enumerate(ParameterGrid(param_grid)):
    ...
    if (conctype in list_conctype_fi) & (groupsplit in list_groupsplit_fi):
        ...
        filename_ending = '_'.join((challenge, modeltype, 'featimp-impurity', chem_fp, groupsplit, conctype)) + '.csv'
        ...
        filename_ending = '_'.join((challenge, modeltype, 'permimp-trainvalid', chem_fp, groupsplit, conctype)) + '.p'
        ...
        filename_ending = '_'.join((challenge, modeltype, 'permimp-test', chem_fp, groupsplit, conctype)) + '.p'
        ...
        # Save Explainer 
        filename_ending = '_'.join((challenge, modeltype, 'explainer', chem_fp, groupsplit, conctype)) + '.sav'
        ...
        # Save shap values
        filename_ending = '_'.join((challenge, modeltype, 'shapvalues', chem_fp, groupsplit, conctype)) + '.sav'
        ...
        filename_ending = '_'.join((challenge, modeltype, 'data', chem_fp, groupsplit, conctype)) + '.csv'
        ...
        # store model
        filename_ending = '_'.join((challenge, modeltype, 'model', chem_fp, groupsplit, conctype)) + '.joblib'
