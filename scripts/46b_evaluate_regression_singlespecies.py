...
def compile_errors(modeltype):
    ...
    df_test = pd.read_csv(path_output + modeltype + '_test-errors_singlespecies.csv')
...
if do_store_images:
    fig.write_image(path_figures + '46b_singlespecies_' + challenge + '_' + metric + '-vs-models_validation.pdf')
fig.show()
...
if do_store_images:
    fig.write_image(path_figures + '46b_singlespecies_' + challenge + '_rmse-r2-vs-models_test.pdf')
fig.show()

# %%
# %%

# TODO check if still needed for singlespecies
