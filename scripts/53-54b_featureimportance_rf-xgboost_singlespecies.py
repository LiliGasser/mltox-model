...
# sparse GP
path_output_dir = path_vmoutput_gp + '2023-11-24_from-updated-adore_singlespecies/'
df_p_gp_all = utils.read_result_files(path_output_dir, file_type='preds')

# LASSO
path_output_dir = path_vmoutput_lasso + '2023-11-24_from-updated-adore_singlespecies/'
df_p_lasso_all = utils.read_result_files(path_output_dir, file_type='preds')

# RF
path_output_dir = path_vmoutput_rf + '2023-11-24_from-updated-adore_singlespecies/'
df_p_rf_all = utils.read_result_files(path_output_dir, file_type='preds')

# XGBoost
path_output_dir = path_vmoutput_xgboost + '2023-11-24_from-updated-adore_singlespecies/'
...
df_p = eval.filter_and_merge_predictions(df_p_gp_all, 
                                         ...
                                         conctype,
                                         tax_pdm='none')
df_p = df_p[df_p['challenge'] == challenge]
